...
class PasswordManager:
    ...
    def remove_account_credentials(cls):
        ...
        while True:
            ...
            cls.display_one_user_credential()
            choice = input()
            if choice == "y" or choice == "Y":
                cls.c.execute("DELETE FROM " + cls.user_id + " WHERE account_id = ?", (account_id,))
    ...
    def display_one_user_credential(cls, account_id):
        print(cls.user_id)
        row = cls.c.execute("SELECT * FROM " + cls.user_id + " WHERE account_id = ", (account_id,)).fetchone()
